-- Миграция 0014: Создание таблиц вики
-- Создание таблиц
...
-- Добавление внешних ключей с проверкой на существование
DO $$ BEGIN
...
-- Триггер для автоматического обновления search_vector (удаляем старый если есть, создаем новый)
