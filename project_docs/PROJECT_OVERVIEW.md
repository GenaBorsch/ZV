...
**Функциональность:**
- ✅ **Создание отчётов мастерами** с выбором игроков и описанием игры
...
**Последнее обновление документации**: Январь 2025 - добавлена система заявок в группы с уведомлениями
