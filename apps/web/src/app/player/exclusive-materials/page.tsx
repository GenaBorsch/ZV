...
export default function PlayerExclusiveMaterialsPage() {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-muted-foreground">
                  Эксклюзивные PDF материалы для владельцев путёвок
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card p-8 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Для доступа к дополнительным материалам необходимо приобрести хотя бы одну путёвку.
              </p>
              <Link href="/player/battlepass">
